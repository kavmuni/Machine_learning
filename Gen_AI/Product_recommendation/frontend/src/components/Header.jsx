    ...
    <header>
      ...
      <div className="bg-[#232F3E] px-6 py-3 flex items-center gap-4 shadow-md">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-semibold text-base tracking-tight">ProductMatch</span>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-[#5F6B7A]">
              ...
              Pick a product and see how each method ranks similar items.
            </p>
          </div>
          <div className="hidden md:flex items-center gap-3 mt-1">
            ...
            <div className="text-right">
              <div className="text-xs text-[#8D99A5] uppercase tracking-wide font-semibold">Products</div>
