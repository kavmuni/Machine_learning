      ...
      <div className="p-5">
        ...
        <div className="mt-5 bg-[#E8F2FF] border border-[#B5D3F5] rounded-lg px-4 py-3">
          <p className="text-xs text-[#0551A3] leading-relaxed">
            ...
            FastText (Wiki News) handles unusual words via character n-grams. BGE-M3 (2024) provides state-of-the-art multi-lingual dense embeddings.
            BoW just counts — still works well for genre/director matches.
          </p>
        </div>
      </div>
    </div>
